...
const ASSESSMENT_ENGINE_VERSION = 'v1.2'
    ...
    <section>
      ...
      <div className="rounded-nasaq-sm border border-sidebar-muted/30 bg-brand-dark-alt/50 px-3 py-3">
        <div className="flex items-center gap-2">
          ...
          <p
            className="truncate text-xs font-semibold text-sidebar-text"
            title={`Model: ${ASSESSMENT_MODEL}`}
          >
            Assessment engine {ASSESSMENT_ENGINE_VERSION}
          </p>
        </div>
